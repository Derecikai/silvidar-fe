...
export default function CartItem({ data }: TCartItem) {
  ...
  return (
    <div className="flex w-[100%] items-center mt-2 px-3  border-b-main-700/20 border-b h-[30%] p-3 justify-between gap-10">
      ...
      <div className="flex items-center min-w-[20%]  md:min-w-[47%] md:max-w-[45%] gap-14 md:mx-auto md:justify-between md:gap-15">
        ...
        <div className="flex items-center ">
          <button
            ...
            className="w-[20px] h-[20px] md:w-[40px] md:h-[40px] bg-slate-500/20 hover:bg-slate-200 rounded-md mr-2"
          >
            -
          </button>
          <p className={`${roboto.className} text-sm md:text-lg text-main-600`}>
          ...
          <button
            ...
            className="w-[20px] h-[20px] md:w-[40px] md:h-[40px] bg-slate-500/20 rounded-md ml-2 hover:bg-slate-200"
          >
            +
          </button>
        </div>
