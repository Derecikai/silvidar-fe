...
export default function Navbar2() {
  return (
    <div className="relative w-[98%] h-[100%] mx-auto flex justify-center bg-secondary-4 backdrop-blur-md rounded-b-3xl px-6 py-4">
      <div className="absolute text-sm h-[80%] w-[36%] items-center rounded-tl-3xl left-0 flex gap-12 px-6 pl-14 pt-7  bg-white text-main-600 top-5 font-medium rounded-tr-3xl z-10">
